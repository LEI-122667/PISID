...
if (!isset($blocked) && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $scriptPath = realpath(__DIR__ . "/../scripts/nuvemToDBs/htmlNuvemToDatabasesWithMongoReplicas.py");
                ...
                <form method="POST">
                    <div class="dashboard-grid" style="margin-top: 0;">
                        <div>
                            ...
                            <p style="color: var(--text-secondary); font-size: 0.9rem;">Equipa:
                                <strong><?= htmlspecialchars($equipa) ?></strong>
                            </p>
                        </div>
